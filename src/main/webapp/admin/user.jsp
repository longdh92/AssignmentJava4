					...
					<div class="col-lg-7">
						<div class="card shadow-lg border-0 rounded-lg mt-5">
							...
							<div class="card-body">
								...
								<div class="form-group">
									<label class="small mb-1">Username</label><input
										...
										placeholder="Enter Username" name="username2"
										required="required"
										value="<%=ShareHelper.ADMIN.getUsername()%>"
										disabled="disabled" />
								</div>
								<div class="form-group">
									<label class="small mb-1" for="inputEmailAddress">Email</label><input
										...
										name="email2" required="required"
										value="<%=ShareHelper.ADMIN.getEmail()%>" />
								</div>
								<div class="form-row">
									<div class="col-md-6">
										<div class="form-group">
											<label class="small mb-1" for="inputPassword">Password</label><input
												...
												required="required"
												value="<%=ShareHelper.ADMIN.getPassword()%>" />
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label class="small mb-1" for="inputConfirmPassword">Confirm
												...
												placeholder="Confirm password" name="confirm2"
												required="required"
												value="<%=ShareHelper.ADMIN.getPassword()%>" />
										</div>
									</div>
								...
								<div class="form-group mt-4 mb-0">
									<button class="btn btn-primary btn-block" name="command"
										value="update">Update Account</button>
								</div>
								<br>
							...
							<div class="card-footer text-center">
								<div class="small">
									<a href="${pageContext.request.contextPath}/admin/admin.jsp">Back
										to Admin</a>
								</div>
							</div>
						</div>
